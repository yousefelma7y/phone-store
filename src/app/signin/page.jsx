    ...
    <div className="relative flex justify-center items-center min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 -left-4 bg-blue-500 opacity-20 blur-3xl rounded-full w-96 h-96 animate-pulse"></div>
          <div
      ...
      <div className="relative z-10 px-4 py-8 w-full max-w-2xl">
              ...
              <Form className="relative z-10 space-y-6">
                ...
                <div className="mb-8 text-center">
                  <div className="flex justify-center mb-4">
                    <div className="flex justify-center items-center bg-gradient-to-br from-blue-400 to-blue-600 shadow-lg shadow-blue-500/50 rounded-2xl w-16 h-16">
                      <svg
                  ...
                  <p className="font-medium text-blue-100/80 text-base">
                ...
                <div className="space-y-2">
                  <div dir="rtl" className="flex justify-between items-center">
                    ...
                    <ErrorMessage
                      name="userName"
                      component="div"
                      className="font-semibold text-red-400 text-xs"
                    />
                  </div>
                  <div className="relative">
                    ...
                    <Field
                      ...
                      className="backdrop-blur-sm bg-white/10 hover:bg-white/15 shadow-lg px-4 pr-10 py-3.5 border border-white/20 rounded-xl focus:border-blue-400 focus:ring-2 focus:ring-blue-400/50 focus:outline-none w-full text-white transition-all duration-200 placeholder:text-blue-200/50"
                ...
                {/* <div className="pt-4 text-center">
                  <a
                    href="#"
                    className="font-medium text-blue-300 text-sm hover:text-blue-200 transition-colors"
                  >
                    نسيت كلمة السر؟
                  </a>
                </div> */}
        ...
        <div className="mt-6 space-y-2 text-center">
          <div className="pt-4 border-t border-white/10">
            <p className="flex justify-center items-center gap-1 font-medium text-blue-200/80 text-xs">
              <svg
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 mt-1.5 font-semibold text-blue-300 text-xs hover:text-blue-200 transition-colors"
            >
              <svg
                className="w-3.5 h-3.5"
                fill="none"
