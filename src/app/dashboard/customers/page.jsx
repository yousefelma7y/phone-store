          ...
          initialValues={
            editingCustomer
              ? {
                  ...
                  birthdayDate: editingCustomer?.birthdayDate?.split("T", 1),
                }
              : initialFormValues
          }
          ...
          <ContentTable
            data={customers.map((customer) => {
              return {
                ...
                birthdayDate: customer?.birthdayDate?.split("T", 1) || "-",
              };
            })}
            nodata="عملاء"
            actions={[
              {
                ...
                action: (customer) => {
                  ...
                  const fullOrder = customers.find(
                    (o) => o._id === customer._id
                  );
            ...
            // ignore={["_id"]}
            header={["id", "إسم العميل", "رقم الهاتف", "تاريخ الميلاد"]}
